...
<body>
    ...
    <div class="form-section container">
        <img src="photos/ki9.jpg" alt="Current Account" class="img-fluid">
        <div class="form-container">
            <h2>Create Salary Account</h2>
...
<% } %>
            <form action="create_salary_account" method="POST" onsubmit="return validateForm();">
               
                <div class="form-group">
                    <label for="accountNumber">Account Number</label>
                    <input type="text" id="accountNumber" name="accountNumber" value="" readonly required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="accountType" name="accountType" required>
                        <option value="current">Salary Account</option>
                    </select>
                </div>
...
<div class="container mt-5">
    <u><h2 class="text-center mb-4">Benefits of a Salary Account</h2></u>
    <div class="row">
        <div class="col-md-4">
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <h5 class="card-title">Hassle-Free Salary Deposits</h5>
                    <p class="card-text">Receive your salary directly into your account every month without any delays or complications.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <h5 class="card-title">Zero Maintenance Fees</h5>
                    <p class="card-text">Enjoy the benefit of zero monthly maintenance fees, allowing you to save more from your salary.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm mb-4">
                <div class="card-body">
                    <h5 class="card-title">Instant Access to Funds</h5>
                    <p class="card-text">Access your salary anytime, anywhere through ATMs, online banking, or mobile apps.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    <p class="card-text">"Opening a salary account was seamless, and the zero maintenance fees are a huge plus!" - Emma J.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    <p class="card-text">"United Bank makes managing my salary easy with their online banking platform!" - Liam T.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    <p class="card-text">"The instant access to funds and secure transfers are excellent features for my salary account!" - Olivia S.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="faq-section container">
    ...
    <div class="faq-item">
        <h5 class="faq-question">1. What documents are required to open a salary account?</h5>
        <p class="faq-answer">Answer: You need to provide a valid ID (National ID or Passport), an employment letter, and a minimum opening deposit.</p>
    </div>
    <div class="faq-item">
        <h5 class="faq-question">2. Is there a minimum balance requirement?</h5>
        <p class="faq-answer">Answer: No, there is no minimum balance requirement for salary accounts.</p>
    </div>
    <div class="faq-item">
        <h5 class="faq-question">3. Can I open a salary account online?</h5>
        <p class="faq-answer">Answer: Yes, you can open a salary account online through our website in a few simple steps.</p>
    </div>
    <div class="faq-item">
        <h5 class="faq-question">4. What are the key benefits of a salary account?</h5>
        <p class="faq-answer">Answer: A salary account offers zero maintenance fees, direct salary deposits, and secure, instant fund access.</p>
    </div>
</div>
...
<div class="container mt-5">
    ...
    <p>Your privacy is important to us. At United Bank, we ensure your personal information is secure and used solely for managing your salary account.</p>
 ...
 <div class="footer">
    ...
    const dob = document.getElementById('dob').value; // Get the date of birth value
    ...
    const birthDate = new Date(dob);  // Convert the dob to a Date object
