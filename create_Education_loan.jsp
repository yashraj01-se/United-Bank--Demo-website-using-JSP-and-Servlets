...
<body>
    ...
    <div class="form-section container">
        <img src="photos/olp4.jpg" alt="Education Loan" class="img-fluid">
        <div class="form-container">
            <h2>Apply for an Education Loan</h2>
            ...
            <% } %>
            <!-- Form to apply for Education Loan -->
            <form action="create_Education_loan" method="POST" onsubmit="return validateForm()">
    ...
    <div class="faq">
        <h5 onclick="toggleAnswer(1)">1. How can I apply for an education loan?</h5>
        <p id="answer-1" style="display: none;">You can apply for an education loan by filling out the online application form on our website. Once submitted, we will review your details and get back to you.</p>
    </div>
    <div class="faq">
        <h5 onclick="toggleAnswer(2)">2. What is the interest rate on the loan?</h5>
        <p id="answer-2" style="display: none;">The interest rate varies depending on the loan amount and tenure. Please check the loan application page for the most current rates.</p>
    </div>
    <div class="faq">
        <h5 onclick="toggleAnswer(3)">3. Can I apply for a loan if I am not a student?</h5>
        <p id="answer-3" style="display: none;">Yes, you can apply for an education loan if you're planning to enroll in a recognized educational institution. You may also need to provide proof of enrollment or admission.</p>
    </div>
    <div class="faq">
        <h5 onclick="toggleAnswer(4)">4. What documents are required for loan application?</h5>
        <p id="answer-4" style="display: none;">The required documents include proof of identity, proof of address, admission letter, and details of the course you're applying for. A complete list will be provided once you start the application process.</p>
    </div>
</div>
...
<div class="container mt-5">
 ...
 <div class="footer">
    ...
    <!-- Add this JavaScript to toggle the FAQ answers -->
<script>
