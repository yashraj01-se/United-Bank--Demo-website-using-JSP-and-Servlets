...
<head>
    ...
    <title>Home Loan Information - United Bank</title>
...
<section class="hero-section">
    <div class="container">
        ...
        <p>Affordable rates, flexible terms, and fast approvals. Secure your home loan today!</p>
        <p>At United Bank, we believe in turning your dreams into reality. With dedicated support, tailored plans, and competitive rates, we help you move into your perfect home without stress.</p>
        <p>Whether you're a first-time buyer or looking to upgrade, our streamlined application process ensures a hassle-free journey to homeownership.</p>
        <a href="create_home_loan.jsp" class="btn btn-dark btn-lg" style="margin-top: 20px">Apply Now</a>
    </div>
</section>

<!-- Eligibility Section -->
<section id="eligibility" class="container py-5">
    <u><h2 class="section-title text-center">Home Loan Eligibility Criteria</h2></u>
    <div class="row text-center">
        <div class="col-md-4">
            <div class="info-box">
                <h5>Age</h5>
                <p>Between 21-65 years of age</p>
                <img src="photos/lo_1.jpg" class="img-fluid" alt="Age Criteria">
            </div>
        </div>
        <div class="col-md-4">
            <div class="info-box">
                ...
                <img src="photos/ct.jpg" class="img-fluid" alt="Income Criteria">
            </div>
        </div>
        <div class="col-md-4">
            <div class="info-box">
                <h5>Credit Score</h5>
                <p>Minimum credit score of 700</p>
...
<section id="loan-benefits" class="container py-5">
    <u><h2 class="section-title text-center">Home Loan Benefits</h2></u>
    <div class="row">
        <div class="col-md-4">
            <div class="benefit-item">
                <h5>Competitive Rates</h5>
                <p>Enjoy some of the lowest rates in the industry.</p>
                <img src="photos/ct1.jpg" class="img-fluid" alt="Low Interest Rates">
            </div>
        </div>
        <div class="col-md-4">
            <div class="benefit-item">
                <h5>Fast Approvals</h5>
                <p>Quick application reviews and loan disbursals.</p>
        ...
        <div class="col-md-4">
            <div class="benefit-item">
                ...
                <p>Repayment plans tailored to suit your budget.</p>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="testimonial">
                <p>"United Bank made buying our first home so simple and stress-free!"</p>
                <div class="testimonial-author">- Sarah P.</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="testimonial">
                <p>"The rates and service were unbeatable. Thank you, United Bank!"</p>
                <div class="testimonial-author">- John D.</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="testimonial">
                <p>"Their flexible repayment options really helped us manage our budget."</p>
...
<section id="faq" class="container py-5">
    ...
    <div class="faq-item">
        ...
        <p>The maximum amount is based on your income and repayment capacity.</p>
    </div>
    <div class="faq-item">
        <h5>How long does it take to get approved?</h5>
        <p>Approval usually takes 48 hours, provided all documents are complete.</p>
    </div>
</section> 
    <!-- Contact Section -->
