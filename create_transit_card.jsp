...
<html lang="en">
    <head>
        ...
        <title>Transit Card Application - United Transit</title>
        <style>
            body {
    ...
    <body>
        ...
        <div class="form-section">
            <u><h2>Apply for United Transit Card</h2></u>
            <p>Fill in your details to apply for your transit card.</p>
            ...
            <!-- Application Form -->
            <form action="create_transit_card" method="post">
                <!-- Personal Details -->
                ...
                <select name="cardType" required>
                    <option value="CityPass">CityPass Transit Card</option>
                    <option value="MetroCard">MetroCard Transit Card</option>
                    <option value="FlexiTravel">FlexiTravel Transit Card</option>
                </select>
