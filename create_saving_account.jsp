...
<body>
    ...
    <div class="form-section container">
        <img src="photos/savings-account.jpg" alt="Savings Account" class="img-fluid">
...
<% } %>
            ...
            <form action="create_saving_account" method="POST" onsubmit="return validateForm();">
                <!-- Full Name -->
   ...
   <div class="container mt-5">
       <u><h2 class="text-center mb-4">Benefits of a Savings Account</h2></u>
        <div class="row">
            <div class="col-md-4">
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <h5 class="card-title">Earn Interest</h5>
                        <p class="card-text">Your money earns interest over time, helping it grow passively.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">Savings accounts are a safe place to store your money, backed by the bank?s security measures.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        <h5 class="card-title">Access Your Money</h5>
                        <p class="card-text">Easily withdraw or transfer money whenever you need it.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <p class="card-text">"Opening a savings account at United Bank was a simple process, and the staff was very helpful. I?m happy with the interest rates!" - John D.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <p class="card-text">"The online account creation was quick, and I was able to access my funds instantly. Great service!" - Sarah M.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <p class="card-text">"United Bank?s savings accounts are fantastic. The interest keeps growing, and I feel secure with my money here." - Maria P.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="faq-section container">
        ...
        <div class="faq-item">
            <h5 class="faq-question">1. What documents are required to open a savings account?</h5>
        ...
        <div class="faq-item">
            ...
            <p class="faq-answer">Answer: Yes, a minimum balance of $50 is required to maintain your savings account.</p>
        </div>
        <div class="faq-item">
            <h5 class="faq-question">3. Can I open an account online?</h5>
            <p class="faq-answer">Answer: Yes, you can open a savings account online through our website.</p>
        </div>
        <div class="faq-item">
            <h5 class="faq-question">4. What are the interest rates for savings accounts?</h5>
            <p class="faq-answer">Answer: Interest rates for savings accounts vary based on the account type. Please check our website for the latest rates.</p>
        </div>
    </div>
