...
<body>
    ...
    <div class="form-section container">
        <img src="photos/ku.jpg" alt="Home Loan" class="img-fluid">
        <div class="form-container">
            ...
            <% if (success != null && success.equals("loan_application_success")) { %>
                <div class="message success-message">
                    Your home loan application has been submitted successfully. After verifying your details, we will contact you shortly.
                </div>
            <% } %>

            <form action="create_home_loan" method="post" onsubmit="return validateForm();">
    ...
    <div class="container faq-section">
        <h3>Home Loan FAQs</h3>
        <div class="faq">
            <h5 onclick="toggleFAQ(this)">What is a Home Loan?</h5>
            <p>A home loan is a type of loan where the property being purchased acts as collateral. This loan is used for buying, constructing, or renovating a house.</p>
        </div>
        <div class="faq">
            <h5 onclick="toggleFAQ(this)">How much can I borrow?</h5>
            <p>You can borrow an amount based on your income, property value, and credit score, with a limit of up to 80% of the property value.</p>
        </div>
        <div class="faq">
            <h5 onclick="toggleFAQ(this)">What is the interest rate on a Home Loan?</h5>
            <p>The interest rate varies based on the loan amount and tenure. Please contact us for more detailed information.</p>
        </div>
    </div>
