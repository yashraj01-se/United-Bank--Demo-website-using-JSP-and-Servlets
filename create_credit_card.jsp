...
<html lang="en">
    <head>
        ...
        <title>Apply for Credit Card - United Bank</title>
        <style>
            body {
    ...
    <body>
        ...
        <div class="form-section">
            <u><h2>Apply for Your United Bank Credit Card</h2></u>
            <p>Fill in your details to apply for one of our credit cards and enjoy exclusive benefits.</p>
            <%
            ...
            <% }%>
            <!-- Form -->
            <form action="create_credit_card" method="post">
                <!-- Personal Details -->
                ...
                <select name="cardType" required>
                    ...
                    <option value="Times Black Premium Credit Card">Times Black Premium Credit Card</option>
                    <option value="Emeralde Private Metal Credit Card">Emeralde Private Metal Credit Card</option>
