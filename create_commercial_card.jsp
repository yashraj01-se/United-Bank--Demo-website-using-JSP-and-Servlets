...
<html lang="en">
    <head>
        ...
        <title>Commercial Transit Card Application - United Transit</title>
        <style>
            body {
    ...
    <body>
        ...
        <div class="navbar">
            <div class="logo-container">
                ...
                <div class="logo">United Transit</div>
            </div>
            <div>
        ...
        <div class="form-section">
            <u><h2>Apply for Commercial Transit Card</h2></u>
            <p>Fill in your business details to apply for a commercial transit card.</p>
            ...
            <div class="message error-message">
                Not Eligible for Commercial Card.
            </div>
            <% } %>
            ...
            <form action="create_commercial_card" method="post">
                <!-- Business Details -->
                <h3>Business Details</h3>
                <input type="text" name="businessName" placeholder="Business Name" required />
                <input type="email" name="email" placeholder="Business Email" required />
                <input type="text" name="phone" placeholder="Business Phone Number(Registered Number)" required />
                <input type="text" name="address" placeholder="Business Address" required />
                <input type="text" name="registrationNo" placeholder="Business Registration No" required />

                <!-- Card Type -->
                <h3>Card Type</h3>
                <select name="cardType" required>
                    <option value="Bussiness">Business Commercial Card</option>
                    <option value="Corporate">Corporate Travel Card</option>
                    <option value="Puchasing">Purchasing Card</option>
                </select>

                <!-- Financial Information -->
                <h3>Financial Information</h3>
                <input type="number" name="income" placeholder="Business Monthly Income (INR)" required />
                <input type="number" name="creditScore" placeholder="Business Credit Score" required />
