...
<head>
    ...
    <title>Education Loan Information - United Bank</title>
...
<section class="hero-section">
    <div class="container">
        <h1>Fulfill Your dream to study Abroad</h1>
       <p>Affordable rates, flexible terms, and quick approvals. Secure your education loan today!</p>  
<p>At United Bank, we believe in turning your academic dreams into reality. With dedicated support, personalized plans, and competitive rates, we help you pursue your education without financial stress.</p>  
<p>Whether you're a first-time student or continuing your studies, our streamlined application process ensures a smooth journey toward achieving your educational goals.</p>
        <a href="create_Education_loan.jsp" class="btn btn-dark btn-lg" style="margin-top: 20px">Apply Now</a>
    </div>
</section>

<!-- Eligibility Section -->
<section id="eligibility" class="container py-5">
    <u><h2 class="section-title text-center">Education Loan Eligibility Criteria</h2></u>
    <div class="row text-center">
        <div class="col-md-4">
            <div class="info-box">
                <h5>Age</h5>
                <p>Between 18-35 years of age</p>
                <img src="photos/olp.jpg" class="img-fluid" alt="Age Criteria">
            </div>
        </div>
        <div class="col-md-4">
            <div class="info-box">
                <h5>Income</h5>
                <p>Stable and sufficient income from a recognized source</p>
...
<section id="loan-benefits" class="container py-5">
    <u><h2 class="section-title text-center">Education Loan Benefits</h2></u>
    <div class="row">
        <div class="col-md-4">
            <div class="benefit-item">
                <h5>Competitive Rates</h5>
                <p>Enjoy some of the lowest interest rates in the industry.</p>
        ...
        <div class="col-md-4">
            <div class="benefit-item">
                ...
                <p>Quick application reviews and fast disbursement of loans.</p>
        ...
        <div class="col-md-4">
            <div class="benefit-item">
                ...
                <p>Repayment plans designed to fit your budget and income.</p>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="testimonial">
                <p>"United Bank made funding my education so simple and affordable!"</p>
                <div class="testimonial-author">- Sarah P.</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="testimonial">
                <p>"The interest rates were unbeatable, and their support was excellent."</p>
                <div class="testimonial-author">- John D.</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="testimonial">
                <p>"Flexible repayment options allowed me to focus on my studies without stress."</p>
...
<section id="faq" class="container py-5">
    ...
    <div class="faq-item">
        ...
        <p>The maximum loan amount is based on the course, institution, and your repayment capacity.</p>
    </div>
    <div class="faq-item">
        <h5>How long does it take to get approved?</h5>
        <p>Approval usually takes 48-72 hours, provided all documents are in order.</p>
    </div>
</section>
    <!-- Contact Section -->
