...
<body>
    ...
    <div class="form-section container">
        <img src="photos/nm.jpg" alt="Personal Loan" class="img-fluid">
        ...
        <h2>Apply for a Car Loan</h2>
            ...
            <!-- Form to apply for Car Loan -->
            <form action="create_car_loan" method="POST" onsubmit="return validateForm();">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="car-model" name="car-model" placeholder="Enter the car model you want to finance" required>
                </div>
                <div class="form-group">
   ...
   <div class="container faq-section">
        ...
        <div class="faq">
            <h5 onclick="toggleFAQ(this)">What is the minimum income required for a car loan?</h5>
            <p>We typically require an income of at least $2,000 per month to qualify for a car loan.</p>
        </div>
        <div class="faq">
            <h5 onclick="toggleFAQ(this)">How long does it take to approve a car loan?</h5>
            <p>The approval process can take up to 3 business days, depending on your application and documentation.</p>
        </div>
        <div class="faq">
            <h5 onclick="toggleFAQ(this)">Can I apply for a car loan if I have bad credit?</h5>
            <p>We offer loans for individuals with varying credit histories. Please contact us to discuss your specific situation.</p>
        </div>
   </div>
