...
<html lang="en">
    <head>
        ...
        <title>Apply for Debit Card - United Bank</title>
        <style>
            body {
    ...
    <body>
        ...
        <div class="form-section">
            <u><h2>Apply for Your United Bank Debit Card</h2></u>
            <p>Fill in your details to apply for one of our Debit cards and enjoy exclusive benefits.</p>
            <%
            ...
            <% }%>
            <!-- Form -->
            <form action="create_debit_card" method="post">
                <!-- Personal Details -->
                ...
                <select name="cardType" required>
                    <option value="Basic Debit Card">Basic Debit Card</option>
                    <option value="Gold Debit Card">Gold Debit Card</option>
