...
<head>
    ...
    <title>Apply for Forex Card - United Bank</title>
    <style>
             body {
...
<div class="form-section">
    <u><h2>Apply for Your United Bank Forex Card</h2></u>
    <p>Fill in your details to apply for one of our Forex Cards and enjoy seamless international transactions.</p>
...
<% } %>
    <!-- Form -->
    <form action="create_forex_card" method="post">
        <!-- Personal Details -->
        ...
        <select name="cardType" required>
            <option value="Global Travel Forex Card">Global Travel Forex Card</option>
            <option value="Premium Travel Forex Card">Premium Travel Forex Card</option>
            <option value="Student Forex Card">Student Forex Card</option>
        </select>

        <!-- Travel Information -->
        <h3>Travel Information</h3>
        <input type="text" name="destination" placeholder="Destination Country" required />
        
        <input type="number" name="amountRequired" placeholder="Amount (in foreign currency)" required />
